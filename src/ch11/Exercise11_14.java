...
public class Exercise11_14 {
    ...
    static int displayMenu() {
        ...
        while(true){
            ...
            menu = s.nextInt();
            if(menu<1 || menu >3){
                System.out.println("메뉴를 잘못 선택하셨습니다. 다시 입력하세요.");
            }else{
                break;
            }
        }
    ...
    static void inputRecord() {
        ...
        while (true) {
            ...
            try{
                ...
                record.add(new Student3(
                        s2.next(),s2.nextInt(),s2.nextInt(),s2.nextInt(),s2.nextInt(),s2.nextInt()
                ));

                System.out.println("잘 입력되었습니다. 입력을 마치려면 q를 입력하세요");
            }catch (Exception e){
                e.printStackTrace();
                System.out.println("입력 오류 입니다. 이름,반,번호,국어성적,영어성적,수학성적 순서대로 입력하세요.");
            }
        }
    }
